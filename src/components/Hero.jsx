...
import Fanta1 from "../assets/one.png";
import Fanta2 from "../assets/two.png";
import Fanta3 from "../assets/three.png";
...
const headphoneData = [
  {
    ...
    subtitle:
      "Elevate your wardrobe with our **Men's Colourblock Crew Neck Sweater** 🧥✨ Perfectly crafted for comfort and elegance.",
    price: "Rs.999",
    modal: "Sweater",
    bgColor: "#cf4f00",
  },
  {
    ...
    subtitle:
      "Elevate your style with the perfect black hoodie,Versatile, comfy, and timeless—this one's a must-have in your wardrobe. Grab yours today!",
    price: "Rs.999",
    modal: "Jacket",
    bgColor: "#727272",
  },
  {
    id: 3,
    image: Fanta3,
    title: "Royal Purple Hoodie",
    subtitle:
      "Introducing **Aura Loom's** Winter Collection Hoodies in *Royal Purple*! 💜 Stay trendy, warm, and stylish this season. ❄️",
    price: "Rs.999",
    modal: "Hoodie",
    bgColor: "#ac1a00",
  },
          ...
          <div className="flex flex-col justify-end items-center relative order-1 md:order-2 ">
            <AnimatePresence mode="wait">
              <motion.img
                ...
                alt=""
                className="w-[150px] md:w-[200px] xl:w-[430px] img-shadow relative z-10"
              />
            </AnimatePresence>
            <AnimatePresence mode="wait">
              <motion.div
